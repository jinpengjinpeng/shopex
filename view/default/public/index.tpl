...
<body>
<script src="view/bootstrap/js/jquery-1.11.3.min.js"></script>
<script src="view/bootstrap/js/bootstrap.min.js"></script>
{include file='default/public/header.tpl'}
<div id="main">
	<div class="conta adver">
		<img src="view/default/images/adver.jpg" alt="First slide" />
		{*<div id="myCarousel" class="carousel slide">
			...
			<div class="carousel-inner">
				...
				<div class="item">
					<img src="view/default/images/3.jpg" alt="Second slide" />
				</div>
				<div class="item">
					<img src="view/default/images/2.jpg" alt="Third slide" />
				</div>
			</div>
			<!-- 轮播（ Carousel）导航 -->
